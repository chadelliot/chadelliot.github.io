          ...
          <div className="px-6 md:px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input name="name" type="text" required maxLength={100} className="w-full px-3.5 py-2.5 rounded-md border border-border bg-card text-foreground font-sans text-[13px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors" placeholder="Your name" />
              </div>
              ...
              <div>
                ...
                <input name="email" type="email" required maxLength={255} className="w-full px-3.5 py-2.5 rounded-md border border-border bg-card text-foreground font-sans text-[13px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors" placeholder="you@company.com" />
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-sans text-[10px] tracking-[0.12em] uppercase text-muted-foreground mb-1.5 block">Company</label>
                  <input name="company" type="text" maxLength={100} className="w-full px-3.5 py-2.5 rounded-md border border-border bg-card text-foreground font-sans text-[13px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors" placeholder="Company" />
                </div>
                <div>
                  <label className="font-sans text-[10px] tracking-[0.12em] uppercase text-muted-foreground mb-1.5 block">Subject</label>
                  <input name="subject" type="text" maxLength={200} className="w-full px-3.5 py-2.5 rounded-md border border-border bg-card text-foreground font-sans text-[13px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors" placeholder="Topic" />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea name="message" required maxLength={2000} rows={5} className="w-full px-3.5 py-2.5 rounded-md border border-border bg-card text-foreground font-sans text-[13px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors resize-y" placeholder="Tell me about your project, challenge, or idea..." />
              </div>

              <button type="submit" disabled={sending} className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-md bg-primary text-primary-foreground font-sans text-[12px] tracking-[0.1em] uppercase font-medium hover:opacity-90 transition-opacity cursor-pointer border-none disabled:opacity-50">
            ...
            <div className="mt-8 pt-6 border-t border-border space-y-3">
              <a href="https://www.linkedin.com/in/chadelliot/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 rounded-md border border-border bg-card text-foreground font-sans text-[12px] font-medium hover:border-primary hover:text-primary transition-colors no-underline">
