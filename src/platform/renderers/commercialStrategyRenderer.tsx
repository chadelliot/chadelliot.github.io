            ...
            <>
              ...
              <div className="campaign-grid">
                {(() => {
                  ...
                  const primaryCells = [
                    ["Audience", primary.body ?? "Directional audience", "Target the right launch-stage accounts."],
                    ["Message", primary.foot ?? "Directional message", "Frame the friction before execution starts."],
                    ["Channels", primary.extra?.[0] ?? "Directional channels", "Use a coordinated multi-touch sequence."],
                    ["Sales Handoff / Measurement", primary.extra?.[1] ?? "Directional measurement", "Track workshop conversion, SQLs, and adoption."],
                  ] as const;
                  return primaryCells.map(([label, value, note]) => (
                    <div className="campaign-cell activation-card" key={label}>
                      ...
                      <span className="tag">Launch readiness</span>
                    </div>
                  ));
                })()}
              </div>
