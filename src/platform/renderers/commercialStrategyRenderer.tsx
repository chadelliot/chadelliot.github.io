    ...
    case "commercialActivation":
      return (
        <div className="campaign">
          <div className="campaign-head activation-head">{section.title}</div>
          <div className="campaign-perf activation-summary">
            ...
            <>
              ...
              <div className="campaign-grid">
                {(() => {
                  ...
                  const primaryCells = [
                    ["Audience", primary.body ?? "Directional audience", "Target the right launch-stage accounts before the window closes.", "Launch prep", "tag"],
                    ["Message", "Surface friction before launch", "Frame the friction before launch execution starts.", "Friction before launch", "tag amber"],
                    ["Channels", "Multi-touch account activation", "Use a coordinated launch sequence across priority accounts.", "LinkedIn · Display · Email · SDR · Workshop", "tag blue"],
                    ["Sales Handoff / Measurement", "Track conversion and adoption", "Measure workshop conversion, SQLs, proposal rate, pipeline value, and dashboard adoption.", "Proof and adoption", "tag"],
                  ] as const;
                  return primaryCells.map(([label, headline, note, pills, tagClass]) => (
              ...
              <div className="activation-economics">
                ...
                <div className="activation-table">
                  ...
                  {section.content.slice(1).map((item) => {
                    ...
                    return (
                      <div className="activation-table-row" key={item}>
                        <div className="activation-cell">
                          <div className="activation-label">Channel</div>
                          <div className="activation-value">{parsed.title}</div>
                        </div>
                        <div className="activation-cell">
                          <div className="activation-label">Investment</div>
                          <div className="activation-value">{investment}</div>
                        </div>
                        <div className="activation-cell">
                          <div className="activation-label">Pipeline</div>
                          <div className="activation-value">{pipeline}</div>
                        </div>
                        <div className="activation-cell">
                          <div className="activation-label">Revenue</div>
                          <div className="activation-value">{revenue}</div>
                        </div>
                        <div className="activation-cell">
                          <div className="activation-label">ROI</div>
                          <div className="activation-value">{roi}</div>
                        </div>
                      </div>
                    );
                  })}
