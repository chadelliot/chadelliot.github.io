...
import CompanyDirectoryPageV8 from "./pages/CompanyDirectoryPageV8";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/company" element={<CompanyDirectoryGate><CompanyDirectoryPageV8 /></CompanyDirectoryGate>} />
