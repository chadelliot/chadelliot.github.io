...
function CommercialActivation() {
  ...
  return (
    <div className="campaign">
      <div className="campaign-head activation-head">Commercial Activation: Launch Readiness Intelligence Campaign</div>
      <div className="campaign-perf">
        <span className="section-eye" style={{ marginBottom: 0 }}>
          One named campaign creates launch momentum. Channel economics broaden the reach.
        </span>
      </div>
      ...
      <div className="campaign-grid">
        {[
          ["Audience", "Launch-stage growth accounts", "Growth pharma and biotech teams preparing launches or indication expansions", "Launch prep", "tag"],
          ["Message", "Surface friction before launch", "Identify market access, field, and stakeholder friction before execution", "Friction before launch", "tag amber"],
          ["Channels", "Multi-touch account activation", "LinkedIn, display, email, SDR, and workshop outreach", "LinkedIn · Display · Email · SDR · Workshop", "tag blue"],
          ["Sales Handoff / Measurement", "Track conversion and adoption", "Workshop conversion, SQLs, proposal rate, pipeline value, dashboard use", "Proof and adoption", "tag"],
        ].map(([label, headline, body, pills, tagClass]) => (
          <div className="campaign-cell activation-card" key={label}>
            ...
            {label === "Channels" ? (
              <div className="activation-pills">
                ...
                <span className="tag blue">Display</span>
                <span className="tag amber">Email</span>
                <span className="tag">SDR outreach</span>
                <span className="tag blue">Workshop</span>
              </div>
            ) : (
              <span className={`tag ${tagClass}`}>{pills}</span>
            )}
          </div>
        ))}
      </div>

      <div className="activation-economics">
        <div className="activation-bridge">
          <div className="activation-bridge-pin">
            <div className="activation-bridge-caret">⌃</div>
            <div className="activation-bridge-label">Channel investment and return</div>
          </div>
        </div>
        <div className="activation-economics-head">
          <div className="section-eye" style={{ marginBottom: 0 }}>
            Channel economics
          </div>
          <div className="tiny">Connected to Step 03: Channels</div>
        </div>
        <div className="activation-table">
          <div className="activation-table-head">
            <div>Channel</div>
            <div>Investment</div>
            <div>Pipeline</div>
            <div>Revenue</div>
          ...
          {roiRows.map(([channel, investment, pipeline, revenue, roi]) => (
            <div className="activation-table-row" key={channel}>
              <div className="activation-cell">
                <span className="activation-label">Channel</span>
                <span className="activation-value">{channel}</span>
              </div>
              <div className="activation-cell">
                <span className="activation-label">Investment</span>
                <span className="activation-value">{investment}</span>
              </div>
              <div className="activation-cell">
                <span className="activation-label">Pipeline</span>
                <span className="activation-value">{pipeline}</span>
              </div>
              <div className="activation-cell">
                <span className="activation-label">Revenue</span>
                <span className="activation-value">{revenue}</span>
              </div>
              <div className="activation-cell">
                <span className="activation-label">ROI</span>
                <span className="activation-value">{roi}</span>
              </div>
            </div>
          ))}
        </div>
